...
class DownloadService extends ChangeNotifier {
  ...
  /// App-private directory (avoids scoped-storage cancellations on Android 10+).
  ...
  Future<String?> enqueue({
    ...
    if (!name.toLowerCase().endsWith('.apk') &&
      ...
      if (!name.contains('.')) name = '$name.apk';
    }
    ...
    try {
      ...
      // APKs often need public/shared storage so the package installer can read them.
      // Other files stay in app-private dir to avoid scoped-storage cancel issues.
